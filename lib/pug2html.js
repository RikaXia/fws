...
class Pug2html{
    ...
    init(){
        ...
        if(_ts.debug){
            html += '\r\n<!--fws开发模式start-->';
            html += '\r\n<script>var sockerUrl = "ws://'+fws.localIP+':'+fws.listenPort+'"</script>';
            html += '\r\n<script src="//'+fws.localIP+':'+fws.listenPort+'/staticfile/socket.io/1.7.3/socket.io.js"></script>';
            html += '\r\n<script src="//'+fws.localIP+':'+fws.listenPort+'/main.js"></script>';
            html += '\r\n<!--fws开发模式end-->';
        };
