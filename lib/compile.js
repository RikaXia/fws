...
let compile = (filePath)=>{
    ...
    if(pt.type === 'file'){
        if(fileType === '.pug' && !isFileSlur('pug',filePath)){
            setDist('pug','html');
        ...
        }else if(fileType === '.scss' && !isFileSlur('scss',filePath)){
            setDist('scss','css');
            sass2css(filePath,dist,true);
        }else if(fileType === '.ts' && !isFileSlur('ts',filePath)){
            setDist('ts','js');
            ts2js(filePath,dist);
        }else if(fileType === '.tsx' && !isFileSlur('tsx',filePath)){
            setDist('tsx','jsx');
            ts2js(filePath,dist);
        }else{
