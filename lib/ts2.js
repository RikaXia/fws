...
class Ts2{
    ...
    init(){
        ...
        //编译选项（https://github.com/Microsoft/TypeScript/wiki/Using-the-Compiler-API）
        console.log(_ts.m.ts.ModuleKind)
        let option = {
                alwaysStrict:true,                      //是否启用严格模式
                lib: _ts.m.ts.ScriptTarget.ES5,         //编译库'ES3','ES5','ES2015','ES2016','ES2017','Latest'
                module:_ts.m.ts.ModuleKind.ES2015,      //代码生成规范'None','CommonJs','AMD','UMD','System','ES2015'
